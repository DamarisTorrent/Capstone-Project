          ...
          <Fragment>
            <Container maxWidth="sm">
              ...
              {/* This is the brand checkbox  */}
                <Box sx={{ minWidth: 120, border:1, borderRadius: '16px', color:'gray' } }>
                  <br></br>
              ...
              <Box sx={{ minWidth: 120, border:1, borderRadius: '16px', color:'gray', borderColor:'gray' } }>
                <br></br>
                <FormControl>
                  ...
                  <RadioGroup
                    ...
                    onChange={handleChange}
                  >
                    <FormControlLabel value={150} control={<Radio />} label="Up to $150" />
                    <FormControlLabel value={250} control={<Radio />} label="$150 - $250" />
                    <FormControlLabel value={350} control={<Radio />} label="$250 - $350" />
                    <FormControlLabel value={351} control={<Radio />} label="Over $350" />
                  </RadioGroup>
                </FormControl>
                <br></br>
              </Box>
